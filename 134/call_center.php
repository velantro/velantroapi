			...
			*/
			...
			public function dialplan() {
				...
				//add the public condition
					...
					if($this->queue_callback == 'true') {
						$dialplan["dialplan_details"][$y]["domain_uuid"] = $this->domain_uuid;
						$dialplan["dialplan_details"][$y]["dialplan_detail_tag"] = "action";
						$dialplan["dialplan_details"][$y]["dialplan_detail_type"] = "bind_digit_action";
						$dialplan["dialplan_details"][$y]["dialplan_detail_data"] = "queue-callback,*,exec:lua,queue_callback.lua \${caller_id_number} \${destination_number} \${uuid} \${domain_name}";
						$dialplan["dialplan_details"][$y]["dialplan_detail_group"] = "2";
						$dialplan["dialplan_details"][$y]["dialplan_detail_order"] = $y * 10;
						$y++;
					}
